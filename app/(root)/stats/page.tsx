...
// import ChartAreaGradient from "@/components/ui-support/focus-chart";
// import { useAppUser } from "@/hooks/useAppUser"; // Adjust import path as needed
...
//     if (!focusSessions) return { level: 1, currentXP: 0, requiredForNext: 500, totalXP: 0 };
...
//           case "today":
//             if (sessionDate < startOfDay(now) || sessionDate > endOfDay(now)) return false;
//             break;
//           case "yesterday":
//             const yesterday = subDays(now, 1);
//             if (sessionDate < startOfDay(yesterday) || sessionDate > endOfDay(yesterday)) return false;
//             break;
//           case "lastWeek":
...
//             break;
//           case "custom":
//             if (filters.startDate && sessionDate < filters.startDate) return false;
...
//       if (filters.manuallyAdded === "manual" && !session.manually_added) return false;
//       if (filters.manuallyAdded === "automatic" && session.manually_added) return false;
...
//                   <CardDescription>
//                     {filteredSessions.length} of {focusSessions?.length || 0} sessions
//                   </CardDescription>
//                 </div>
//               </div>
//             </CardHeader>
...
//                             {Math.floor(((session.duration_seconds || 0) / 3600) * 100)} XP
//                           </Badge>
//                         </TableCell>
//                         <TableCell>
//                           <Badge
//                             variant={session.manually_added ? "default" : "outline"}
//                           >
...
//                   </div>
//                   <Progress
//                     value={(careerData.currentXP / careerData.requiredForNext) * 100}
//                     className="h-3"
//                   />
//                   <p className="text-xs text-muted-foreground">
//                     {careerData.requiredForNext - careerData.currentXP} XP to next level
//                   </p>
//                 </div>
...
//                     Earn 100 XP for every hour of focused work. Each level requires
//                     50% more XP than the previous level.
//                   </p>
//                 </div>
//               </CardContent>
//             </Card>
...
//                   <div className="p-3 bg-muted rounded-lg text-center">
//                     <div className="text-2xl font-bold text-primary">
//                       {Math.round(((focusSessions?.reduce((acc, session) =>
//                         acc + (session.duration_seconds || 0), 0) || 0) / 3600) * 10) / 10}h
//                     </div>
//                     <div className="text-xs text-muted-foreground">
//                       Total Time
//                     </div>
...
//                   <div className="p-3 bg-muted rounded-lg text-center">
//                     <div className="text-2xl font-bold text-primary">
//                       {focusSessions?.filter(s => s.manually_added).length || 0}
//                     </div>
//                     <div className="text-xs text-muted-foreground">
//                       Manual Sessions
//                     </div>
...
//                     <div className="text-2xl font-bold text-primary">
//                       {Math.round((focusSessions?.reduce((acc, session) =>
//                         acc + (session.duration_seconds || 0), 0) || 0) / (focusSessions?.length || 1) / 60)}m
//                     </div>
//                     <div className="text-xs text-muted-foreground">
//                       Avg Duration
//                     </div>
...
//                       </div>
//                     )}
//                     {((focusSessions?.reduce((acc, session) =>
//                       acc + (session.duration_seconds || 0), 0) || 0) / 3600) >= 20 && (
//                       <div className="flex items-center gap-2 text-sm">
...
//                   className="col-span-3"
//                   ref={(input) => {
//                     if (input && editingSession.start_time) {
//                       input.value = format(new Date(editingSession.start_time), "yyyy-MM-dd'T'HH:mm");
//                     }
//                   }}
//                 />
//               </div>
...
//                   className="col-span-3"
//                   ref={(input) => {
//                     if (input && editingSession.end_time) {
//                       input.value = format(new Date(editingSession.end_time), "yyyy-MM-dd'T'HH:mm");
//                     }
//                   }}
//                 />
//               </div>
...
//                 if (startInput.value && endInput.value && editingSession) {
//                   handleEditSession(
//                     editingSession.id,
